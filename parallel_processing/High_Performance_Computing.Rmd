...
opts_chunk$set(tidy = FALSE, cache = FALSE, echo = TRUE, eval = FALSE)
...
```{r ex04, fig.cap="Figure 1. Plot comparing unbatched and batched multi-core processing."}
...
```{r ex04_more_processing, fig.cap='Figure 2. Plot comparing unbatched and batched multi-core processing with more "trials" (work) and smaller data size (less memory overhead).'}
...
```{r ex04_more_data, fig.cap='Figure 3. Plot comparing unbatched and batched multi-core processing with "bigger" data (more memory overhead) and fewer "trials".'}
