...
```{r ex04_more_processing, fig.cap='Figure 2. Plot comparing unbatched and batched multi-core processing with 4x more "trials"'}
...
```{r ex04_more_data, fig.cap='Figure 3. Plot comparing unbatched and batched multi-core processing with 4x more data.'}
