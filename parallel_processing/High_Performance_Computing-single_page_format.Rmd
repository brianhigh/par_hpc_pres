...
```{r ex04_inflate_mult, fig.cap="Figure 2. Multi-core test comparing the processing of batched and inflated data using various numbers of CPU cores.", echo=FALSE}
g
```
